...
@pytest.mark.asyncio
async def test_logged_spend_updates_verification_token_spend_when_token_provided():
    """
...
@pytest.mark.asyncio
async def test_logged_spend_updates_verification_token_spend_from_spend_log_api_key():
    """
